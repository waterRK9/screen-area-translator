...
* **Multi-Provider AI Support:**
  * **Google Gemini API:** Smart auto-selection and dynamic failover across vision-capable Flash models.
  * **OpenAI:** Works with `gpt-4o`, `gpt-4o-mini`, or any custom OpenAI model.
  * **Anthropic Claude:** Powered by vision models like `claude-3-5-sonnet`.
...
* **Flexible Model Overrides:** Leave model fields blank to automatically use smart defaults, or specify your preferred model ID.
...
2. Select your preferred **AI Provider**:
   * **Google Gemini API:** Enter your API key. (Leaves model auto-selection on by default).
   * **OpenAI / Claude:** Enter your API key and an optional model override.
...
├── background.js     # Background service worker & API routing logic
